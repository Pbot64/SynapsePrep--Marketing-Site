import wavePattern from "../../static/images/wavePattern.png";
...
export const blueToGreen = {
  background:
    "url(" +
    wavePattern +
    "), linear-gradient(45deg, #2980ba 0%, #238E9B 50%, #00BF6F 100%)",
  backgroundBlendMode: "color-burn",
  "@media (max-width: 600px)": {
...
export const blueToTurquoise = {
  background:
    "url(" +
    wavePattern +
    "), linear-gradient(224deg, #209cff 0%, #68e0cf 100%)",
  backgroundBlendMode: "color-burn",
  "@media (max-width: 600px)": {
...
export const blueToTurquoise1 = {
  background:
    "url(" +
    wavePattern +
    "), linear-gradient(45deg, #3692f6 0%, #52ade7 100%)",
  backgroundBlendMode: "color-burn",
  "@media (max-width: 600px)": {
...
export const blueOpacityReduced = {
  backgroundColor: "rgba(32, 156, 255, 0.5)"
};

export const turquoiseOpacityReduced = {
  backgroundColor: "rgba(104, 224, 207, 0.5)"
};
...
export const blueToTurquoise2 = {
  background:
    "url(" +
    wavePattern +
    "), linear-gradient(45deg, #51ace7 0%, #6ac5d8 100%)",
  backgroundBlendMode: "color-burn",
  "@media (max-width: 600px)": {
...
export const blueToTurquoise3 = {
  background:
    "url(" +
    wavePattern +
    "), linear-gradient(45deg, #64c0d8 0%, #68e0cf 100%)",
  backgroundBlendMode: "color-burn",
  "@media (max-width: 600px)": {
