...
const dates = [
  {
    value: "Assign me a date",
    label: "Assign me a date"
  },
  {
    value: "9/5 + 9/6",
    label: "9/5 + 9/6"
            ...
            >
              ...
              >
                <Typography variant="body1" className={classes.popover}>
                  If you received a flyer, the bootcamp location will be listed
                  on it. If you're homeschooled then select a nearby location.
